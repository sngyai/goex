...
import (
	...
	"github.com/sngyai/goex/bigone"
	"github.com/sngyai/goex/binance"
	"github.com/sngyai/goex/bitfinex"
	"github.com/sngyai/goex/bithumb"
	"github.com/sngyai/goex/bitmex"
	"github.com/sngyai/goex/bitstamp"
	"github.com/sngyai/goex/bittrex"
	"github.com/sngyai/goex/coinbene"
	"github.com/sngyai/goex/kucoin"

	"github.com/sngyai/goex/atop"
	//"github.com/sngyai/goex/coin58"
	"net"
	"net/http"
	"net/url"
	"time"

	"github.com/sngyai/goex/coinex"
	"github.com/sngyai/goex/gdax"
	"github.com/sngyai/goex/hitbtc"
	"github.com/sngyai/goex/huobi"
	"github.com/sngyai/goex/kraken"
	"github.com/sngyai/goex/okex"

	// okexV5 "github.com/sngyai/goex/okex/v5"
	"github.com/sngyai/goex/poloniex"
	"github.com/sngyai/goex/zb"
)
...
func (builder *APIBuilder) Build(exName string) (api API) {
	...
	case OKEX:
		_api = okex.NewOKExV5Spot(&APIConfig{
			HttpClient:    builder.client,
			ApiKey:        builder.apiKey,
			ApiSecretKey:  builder.secretkey,
			ApiPassphrase: builder.apiPassphrase,
