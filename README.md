...
[English](https://github.com/sngyai/goex/blob/dev/README_en.md)

### wiki文档

[文档](https://github.com/sngyai/goex/wiki)
...
``` go get github.com/sngyai/goex ```

>建议go mod 管理依赖
``` 
require (
          github.com/sngyai/goex latest
)
```
